...
class GameEnginesTest: XCTestCase, WrapperTestCallback {
    ...
    func testSingleGameEngines(){
        let params = Parameters()
            .add(ids: "67")
        
        
        wrapper?.gameEngines(params: params, onSuccess: {(jsonResponse: [[String: AnyObject]]) -> (Void) in
            let result = jsonResponse[0]
            
            let id = result["id"] as? Int
            
            XCTAssertEqual(67, id)
    ...
    func testMultipleGameEngines(){
        ...
        wrapper?.gameEngines(params: params, onSuccess: {(jsonResponse: [[String: AnyObject]]) -> (Void) in
            ...
            XCTAssertEqual(id1, 367)
            XCTAssertEqual(id2, 363)
            XCTAssertEqual(id3, 359)
